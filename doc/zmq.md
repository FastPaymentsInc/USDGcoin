...
router", implementing the usdg wire protocol and relay, making
...
during the *configure* step of building usdgd:
...
For instance:
    ...
    $ usdgd -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubhashtx=tcp://192.168.1.2:28332 \
               -zmqpubrawtx=ipc:///tmp/usdgd.tx.raw \
...
These options can also be provided in usdg.conf.
...
From the perspective of usdgd, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into usdgd directly. Furthermore, no information is
