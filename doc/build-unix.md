...
Note
---------------------
Always use absolute paths to configure and compile USDG and the dependencies.
...
This will build usdg-qt as well, if the dependencies are met.
...
Notes
-----
The release is built with GCC and then "strip usdgd" to strip the debug
...
# Configure USDG to use our own-built instance of BDB
cd $BITCOIN_ROOT
./autogen.sh
...
Security
--------
To help make your USDG installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, USDG should be built with a non-executable stack,
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, USDG may be compiled in
...
As mentioned above, when maintaining portability of the wallet between the standard USDG distributions and independently built
