...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("usdgs");
    case mBTC: return QString("Milli-usdgs (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-usdgs (blits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
