...
enum ServiceFlags : uint64_t {
    ...
    // set by all USDG non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered connections.
    // USDG nodes used to support this by default, without advertising this bit,
